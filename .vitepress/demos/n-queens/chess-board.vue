...
<template>
  <div
    class="relative box-content overflow-hidden border rounded-md"
    :style="boardStyle"
  >
    <div class="absolute inset-0">
      <div
        ...
        :key="index"
        :style="coord.style"
        :class="[coord.class, 'absolute', 'flex', 'text-sm']"
      >
        <div
          v-for="_ in n"
          :key="_"
    ...
    <div class="absolute" :style="{ inset: borderStr }">
      <div v-for="(_, y) in n" :key="y" class="relative flex">
        <div
          ...
          :style="{ width: lengthStr, height: lengthStr }"
          @click="$emit('tap', x, y)"
        >
          <div
            v-if="
              ...
              (x === locked[0] ||
                ...
                x - y === locked[3])
            "
            class="i-lucide:lock text-sm text-[#444]"
          />
        </div>
      </div>
      ...
      <div class="absolute left-0 top-0">
        <div
          ...
          class="absolute flex cursor-pointer items-center justify-center transition"
          @click="$emit('tap', x, y)"
        >
          <IconQueen
            :class="[
